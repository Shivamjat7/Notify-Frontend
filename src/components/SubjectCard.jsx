...
const SheduleCard = ({ lectureName, time, location, type,subjectId }) => {
  ...
  return (
    <>
      <Modal subjectId={subjectId} isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
      <div className="relative">
        <div
          onClick={() => setIsModalOpen(true)}
          className="m-1 w-100 max-w-sm bg-white rounded-2xl shadow-gray-300 shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300"
        >
